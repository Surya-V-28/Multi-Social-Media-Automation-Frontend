...
class RemovePlatformConnectionInteractor {
  const RemovePlatformConnectionInteractor(this._backendClient, this._userRepository, this._accessTokenRepository);

  Future<void> remove(String id) async {
    final user = (await _userRepository.getUser())!;
    final accessToken = (await _accessTokenRepository.getToken())!;

    await _backendClient.platformConnectionClient.removePlatformConnection(user.id, id, accessToken);
  }
